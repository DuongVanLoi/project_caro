...
void setup() {
  ...
  colorx=color33=color55=color77=color(135, 206, 250);
...
void draw() {
  ...
  if (buttonxover) {
    ...
    if(choose33){
      ...
      color33=color(255, 250, 250);
      color55=color77=color(135, 206, 250);
    }
    else if (choose55){
      
      color55=color(255, 250, 250);
      color33=color77=color(135, 206, 250);
    }
    else if (choose77){
      
      color77=color(255, 250, 250);
      color33=color55=color(135, 206, 250);
    } 
    else {
        color33=color55=color77=color(135, 206, 250);
    } 
  }
}
...
void title (){
  ...
  textSize(40);
  fill(33);
  text("TIC TAC TOE ROBOT CONTROL", 235, 60); 
  textSize(26);
  fill(0, 104, 139);
  text("Select the mark", 120, 135); 
  text("Select the size", 650, 135); 
}
